...
const validateReportBody = require("../middleware/validateReportBody");
...
router.post(
  ...
  (req, res) => {
    ...
    res.setHeader(
      "Content-Disposition",
      `attachment; filename="ga4-inspector-report-${fileDate}.pdf"`
    );
