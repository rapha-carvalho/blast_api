...
const ALLOWED_EVENT_NAMES = new Set([
  ...
  "cheatsheet_primary_cta_click",
  "cheatsheet_form_start",
  "cheatsheet_gate_view",
  "cheatsheet_unlock",
  "cheatsheet_access",
  "cheatsheet_print",
  "cheatsheet_copy_code",
  "cheatsheet_video_ad_view",
  "cheatsheet_video_interaction",
  "cheatsheet_mobile_preview_view",
  "cheatsheet_mobile_expand",
  "cheatsheet_mobile_close",
  "section_view",
  "sticky_cta_view",
  "sticky_cta_click",
  "exit_intent_show",
