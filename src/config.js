...
module.exports = {
  ...
  stripePriceIdMentorshipGiovanna1x: process.env.STRIPE_PRICE_ID_MENTORSHIP_GIOVANNA_1X || "",
  stripePriceIdMentorshipGiovanna2x: process.env.STRIPE_PRICE_ID_MENTORSHIP_GIOVANNA_2X || "",
  stripePriceIdMentorshipGiovanna3x: process.env.STRIPE_PRICE_ID_MENTORSHIP_GIOVANNA_3X || "",
  stripePriceIdMentorshipGiovanna4x: process.env.STRIPE_PRICE_ID_MENTORSHIP_GIOVANNA_4X || "",
  stripePriceIdMentorshipGiovanna5x: process.env.STRIPE_PRICE_ID_MENTORSHIP_GIOVANNA_5X || "",
  stripePriceIdMentorshipGiovanna6x: process.env.STRIPE_PRICE_ID_MENTORSHIP_GIOVANNA_6X || "",
